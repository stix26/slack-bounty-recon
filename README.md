...
|------|-------|---------|-------|
| 2026-06-30 | Slack.com infrastructure + services | No verified vulnerabilities; slackb.com wildcard CORS noted (low severity) | 11 live targets; open redirects all false positives; 0 secrets discovered |
